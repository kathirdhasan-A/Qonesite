    ...
    >
      {item.label}
            ...
            <motion.div
                ...
                className="fixed top-0 right-0 w-[70%] h-full bg-black text-[#A0A0A0] shadow-lg z-50 md:hidden flex flex-col"
            >
        ...
        {item.label}
            ...
            >
                <motion.div
                    ...
                    className="bg-charcoal w-[55%] text-[#A0A0A0] py-12"
                >
                ...
                <motion.div variants={itemVariants} className="flex gap-5">
                    <button className="bg-[#5D3FD3] text-sm md:h-12 p-2 md:text-md md:px-4 md:py-2 rounded font-semibold">
                        Get Instant Access
                    </button>
